...
export async function proxy(request: NextRequest) {
  ...
  // Marketing, legal and verification pages stay public so crawlers and
  // anonymous visitors (and the sitemap) can reach them without a session.
  ...
  const isPublicAppRoute =
    ...
    relativePath.startsWith('/case-studies/') ||
